...
<html>
    ...
    try
    {
        ...
        String[] destinatarios = new String[ contadorUsuarios + 1 ];
        
        destinatarios[ 0 ] = emailAdmin;
        
        int destinatarioActual = 1;
        ...
        while( it.hasNext() )
        {
            ...
            if( tempRst.next() )
            {
                ...
                if( matchFound )
                {
                    destinatarios[ destinatarioActual++ ] = tempRst.getString( "email" );
                }
            }
        }
        
        if( destinatarioActual != 0 )
        {
            mail.Mailer mailer = new mail.Mailer(emailAdmin, emailPW );
            
            mailer.sendSSLMessage( destinatarios, asunto, contenido, emailAdmin );
