...
<body>
    <form id="form1" action="snippets/CrearAdministrador.jsp" onsubmit="return validateEmail()">
        
        ID Cuenta: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id = "newusername" name="newusername" o/><br/>
        ...
        Email: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;<input type="text" id="usermail" name="usermail" /><br/>
        
        <input type="submit" value="Crear" class="myButton"/>
