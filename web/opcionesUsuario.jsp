					...
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                                ...
                                                <%
                                                    String success = "<div class=\"response-msg success ui-corner-all\"><span>Complete el formulario</span>Llene los campos que aparecen a continuaci&oacute;n para cambiar la contrase&ntilde;a. [NOTA: S&oacute;lo se admite un cambio de contrase&ntilde;a por sesión].</div>";
                                                    String bad = "<div class=\"response-msg error ui-corner-all\"><span>Error:</span>Los datos que ha digitado no son v&aacute;lidos. INTENTE DE NUEVO. [Nota: S&oacute;lo se admite un cambio de contrase&ntilde;a por sesión.</div>";
