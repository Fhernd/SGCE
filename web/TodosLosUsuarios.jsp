...
<head>
    ...
    <script language="javascript">
        ...
        function initDates()
        {
            ...
            //construimos la url definitiva
            //pasando como parametro el valor seleccionado
            var fragment_url = "snippets/GetExtractsForAll.jsp";
...
<body>
    <form id="form2" action="ProcesarCambiarObservacionTodos.jsp" onsubmit="return observacionNueva()">
        ...
        Nueva Observación:
        <br/>
        <textarea name="observacion" id="observacion"  rows="8" cols="52" disabled="true"></textarea>
