	...
	<link href="css/themes/gray_lightness/ui.css" rel="stylesheet" title="style" media="all" />
        ...
        <script language="JavaScript" type="text/javascript"> 
            ...
            { 
                ...
                if (confirm("¿Est\xe1 seguro de querer eliminar todos los extractos para la fecha seleccionada?")) {
                    return true; 
                } else {
                    return false;
                } 
        ...
        <script language="JavaScript" type="text/javascript"> 
            ...
            { 
                ...
                if( document.getElementById('extractDateId').options.length > 0 )
                {
                ...
                {
                    alert( 'No hay extractos para eliminar.')
                    return false;
                }
		...
		<div id="page-layout"><div id="page-content">
			<div id="page-content-wrapper">
				<div class="inner-page-title">
                                    <h2>Gesti&oacute;n de Extractos</h2>
					<span></span>
				</div>
					...
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                ...
                                String bad = "<div class=\"response-msg error ui-corner-all\"><span>Error:</span>Problema con la conexión..</div>";
						...
						<div class="content-box-wrapper">
                                                    <form class="forms" id="signupForm" method="post" enctype="multipart/form-data" action="UploadExtractos.jsp">
								<fieldset>
									<ul>
										<li>
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                                        Enviar Emails de Extractos:
                                                        
						</div>
                                                                        
						<div class="content-box-wrapper">
                                                    
                                                    <center><iframe id="change" width="100%" height="191" src="OperacionesExtractos/EnviarEmail.jsp" style="dispaly:none;"></iframe></center>
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						...
						<div class="content-box-wrapper">
                                                    <form class="forms" id="signupForm" method="post" enctype="POST" action="OperacionesExtractos/EliminarExtracto.jsp" onsubmit="return confirmDelete()">
								<fieldset>
									<ul>
										<li>
										<label class="desc" for="confirm_password">Seleccione la fecha y hora de extractos que desea eliminar:</label>
                                                                                <div>
                                                                                    
                                                                                    <select name="extractDate" id="extractDateId" >
                                                                                        ...
                                                                                        <%
                                                                                            ...
                                                                                            try
                                                                                            {
                                                                                                ...
                                                                                                String query = "SELECT DISTINCT fechasubidaextracto FROM extractos ";

                                                                                                rst = stmt.executeQuery( query );
                                                                                                
                                                                                                while( rst.next() )
                                                                                                {
                                                                                                    out.print( "<option value=\"" + rst.getString( "fechasubidaextracto") + "\">");
                                                                                                    out.print( rst.getString( "fechasubidaextracto" ) );
                                                                                                    out.print( "</option>" );
                                                                                                }
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                                        Eliminar Extractos Por Usuario:
                                                        
						</div>
                                                                        
						<div class="content-box-wrapper">
                                                    
                                                    <center><iframe id="change" width="100%" height="450" src="OperacionesExtractos/EliminarExtractoUnicoUsuario.jsp" style="dispaly:none;"></iframe></center>
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						...
						<div class="content-box-wrapper">
                                                    ...
                                                    <center><iframe id="change" width="100%" height="699" src="OperacionesExtractos/ModificarExtracto.jsp" style="dispaly:none;"></iframe></center>
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                                        MODIFICAR OBSERVACI&Oacute;N INDIVIDUAL:
                                                        
						</div>
                                                                        
						<div class="content-box-wrapper">
                                                    
                                                    <center><iframe id="change" width="100%" height="450" src="UnicoUsuario.jsp" style="dispaly:none;"></iframe></center>
				...
				<div class="column-content-box">
					<div class="content-box content-box-header ui-corner-all">
						<div class="ui-state-default ui-corner-top ui-box-header">
							<span class="ui-icon float-left ui-icon-notice"></span>
                                                        MODIFICAR OBSERVACI&Oacute;N TODOS:
                                                        
						</div>
                                                                        
						<div class="content-box-wrapper">
                                                    
                                                    <center><iframe id="change" width="100%" height="450" src="TodosLosUsuarios.jsp" style="dispaly:none;"></iframe></center>
