...
<head>
	...
	<script type="text/javascript" src="js/custom.js"></script>
        <script type="text/javascript" src="js/custom/certificates.js"></script>
		...
		<div id="page-layout"><div id="page-content">
			<div id="page-content-wrapper">
				<div class="inner-page-title">
					<h2>Certificado Tributario</h2>
                                        <span>Desde este apartado podrá gestionar sus certificados: Visualización, Descarga e Impresi&oacute;n</span>
				</div>
				      ...
				      <th width="59">Descargar</th>
                                    ...
                                    <%
                                        ...
                                        try
                                        {
                                            ...
                                            String query = "SELECT DISTINCT certificados.cuenta_codigocuenta FROM certificados INNER JOIN usuario_has_cuenta ON usuario_has_cuenta.usuario_idcedulanit = " + Long.parseLong( session.getAttribute( "username" ).toString() ) +" AND certificados.cuenta_codigocuenta = usuario_has_cuenta.cuenta_codigocuenta";
                                            ...
                                            while( rst.next() )
                                            {
                                                ...
                                                String querySelectControl = "SELECT DATE_FORMAT(fechaemision,'%d %b %Y') AS 'fecha_formateada', fechaemision FROM certificados WHERE cuenta_codigocuenta = " + rst.getLong( "cuenta_codigocuenta" ) + " GROUP BY fechaemision DESC LIMIT 3";
                                                ...
                                                out.print( "<td name=\"selectMonth\">");
                                                    ...
                                                    while( rstSelect.next() )
                                                    {
                                                        ...
                                                        out.print( "<option value=\"" + rstSelect.getString( "fechaemision" ) + "\">" + rstSelect.getString( "fecha_formateada" ) + "</option>");
                                                    } // end while
                                                ...
                                                out.print( "<td name=\"td\">");
                                                    out.print( "<a href=\"#\" onclick=\"viewCertificate( '" + session.getAttribute( "username" ) + "', '" +  rst.getLong( "cuenta_codigocuenta" ) + "', this );\"><span class=\"ui-icon ui-icon-circle-triangle-e\"></a>");
                                                out.print( "</td>");
                                                
                                                // download report
                                                out.print( "<td>");
                                                    out.print( "<a href=\"#\" onclick=\"downloadCertificate( '" + session.getAttribute( "username" ) + "', '" +  rst.getLong( "cuenta_codigocuenta" ) + "', this );\"><span class=\"ui-icon ui-icon-circle-arrow-s\"></a>");
                                                out.print( "</td>");
