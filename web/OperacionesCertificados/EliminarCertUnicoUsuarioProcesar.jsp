...
<%
    ...
    try
    {
        ...
        if( request.getParameter( "accounts" ) != null )
        {
            ...
            String delQuery1 = "DELETE FROM certificados WHERE cuenta_codigocuenta = " + request.getParameter( "accounts" ) + " AND usuarioid = " + request.getParameter("iDoc");
        ...
        {
            out.print( "<div class=\"warning\">No hay Certificados por eliminar.</div>" );
        }
