...
<body>
    ...
    <form id="form1" action="snippets/ProcesarAdminCambiarContrasegnia.jsp" onsubmit="return observacionNueva()">
        
        <input type="text" id="iDoc" name="contrasegnia" onkeypress="return bar(event)"/>
        <input class="myButton" type="submit" value="Reestablecer Contrase&ntilde;a" class="myButton" >
