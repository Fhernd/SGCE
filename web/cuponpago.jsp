...
<head>
	...
	<script type="text/javascript" src="js/custom.js"></script>
        <script type="text/javascript" src="js/custom/reportingCuponPago.js"></script>
		...
		<div id="page-layout"><div id="page-content">
			<div id="page-content-wrapper">
				<div class="inner-page-title">
                                    <h2>Cup&oacute;n de Pago</h2>
                                    <span>Desde este apartado podrá gestionar su Cup&oacute;n de Pago: Visualización, Descarga e Impresi&oacute;n</span>
				</div>
...
<br /><br />
				...
				<div class="content-box">
				    ...
				    <tr>
                                        <th width="135">N&uacute;mero Cuenta</th>
				      ...
				      <th width="59">Descargar</th>
                                    ...
                                    <%
                                        ...
                                        try
                                        {
                                            ...
                                            String query = "SELECT codigoinquilino FROM usuario_como_inquilino WHERE usuario_idcedulanit = " + Long.parseLong( session.getAttribute( "username" ).toString() );
                                            ...
                                            while( rst.next() )
                                            {
                                                ...
                                                out.print( "<td>");
                                                out.print( rst.getLong( "codigoinquilino"));
                                                out.print( "</td>");
                                                
                                                out.print( "<td name=\"td\">");
                                                out.print( "<a href=\"#\" onclick=\"viewCuponPago( '" + session.getAttribute( "username" ) + "', '" +  rst.getLong( "codigoinquilino" ) + "' );\"><span class=\"ui-icon ui-icon-circle-triangle-e\"></a>");
                                                out.print( "</td>");
                                                
                                                // download report
                                                out.print( "<td>");
                                                out.print( "<a href=\"#\" onclick=\"downloadCuponPago( '" + session.getAttribute( "username" ) + "', '" +  rst.getLong( "codigoinquilino" ) + "' );\"><span class=\"ui-icon ui-icon-circle-arrow-s\"></a>");
                                                out.print( "</td>");
